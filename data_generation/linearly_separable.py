...
np.savetxt("../data/lin_examples_%s_%s" % (num_examples, num_features), examples, delimiter=',')
np.savetxt("../data/lin_labels_%s_%s" % (num_examples, num_features), labels.astype(int), delimiter=',', fmt="%d")
...
if(num_features == 2):
    ...
    fig.savefig("../data/lin_plot_%s_%s.png" % (num_examples, num_features))
